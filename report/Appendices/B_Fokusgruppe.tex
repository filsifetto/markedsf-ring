% Agent documentation:
% Purpose: document the focus-group method, raw response structure, and
% qualitative analysis.
% Downstream use: supports claims about perceived relevance, trust, privacy,
% noise, sustainability, and price sensitivity.
% Revision guardrails: preserve participant anonymization (D1-D4) and frame
% findings as exploratory because the group is small and homogeneous.
...
Metoden gir høy detaljgrad, men lav presisjon
\parencite[Forelesning 7]{aspelund2026_forelesninger}. En svakhet ved fokusgrupper som metode
...
% Trenger kilde på siste setning i avsnittet over
...
\end{itemize}
% Må bytte ut FS4 med et annet lett forskningsspørsmål om pris
...
\end{itemize}
% Må bytte ut H4 med en annen hypotese knyttet til det nye forskningsspørsmålet FS4 om pris

\subsubsection*{Utvalg og rekruttering}

Fokusgruppen bestod av fire deltakere fra samme familie og utgjør dermed en
homogen gruppe som er lite representativ for den generelle befolkningen
og ulike kundesegmenter. Deltakerne er i tillegg lite aktive brukere av
...
å utdype sine synspunkter. Det ble kun gjennomført én fokusgruppe. Dette gir
et lite grunnlag der enkeltstemmer kan bli vektlagt uforholdsmessig mye.
Funnene må derfor tolkes med forbehold.
% Må kanskje finne kilde på det de to siste setningene eller få fram at det er våre tanker og refleksjon
...
spørsmål, lede samtalen og notere hva som ble sagt underveis. Dette utgjør en
svakhet ettersom notatene primært fanger opp verbale utsagn, mens
observasjoner av gruppedynamikk og kropsspråk i liten grad er dokumentert.
...
\begin{itemize}[leftmargin=1.5em, nosep]
  ...
  Foodora/Wolt. Deretter tenke over om tiden man sparer på å slippe å
  ...
  trenger maten.
\end{itemize}
% Kanskje fjerne svaret til D4 og heller skrive "ikke besvart" da det ikke svarer på spørsmålet egentlig
...
\textit{Hva er din aller første tanken?}
\begin{itemize}[leftmargin=1.5em, nosep]
...
\begin{itemize}[leftmargin=1.5em, nosep]
  ...
  \item \textbf{D3:} Dronelevering hadde vært nyttig på hyttetur og båttur
