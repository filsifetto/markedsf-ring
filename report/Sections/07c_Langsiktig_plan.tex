...
Overgangskriteriene til fase 3 supplerer adopsjonsmålet med tre
enhetsøkonomiske terskler. CAC bør ligge i øvre del av nordiske
matleveringsbenchmarks. Globalt snitt for nye matleveringsapper er rundt
45 til 85 dollar per kunde \parencite{businessofapps_uacosts}, noe som i
norsk høykostkontekst tilsvarer rundt 500 til 1\,000 NOK per ny kunde
\parencite{ssb2024}. LTV/CAC-ratioen bør være minst 3 ved måned 18, et
nivå som dokumenterer sunn vekst i tråd med bransjestandarden
\parencite{understory_ltvcac}. Gjenkjøpsraten på 90 dager bør holdes på
minst 40 prosent, samme nivå som piloten, men nå under tyngre konkurranse
fra Foodora og Wolt.
...
Beslutningskriteriet for å gå videre til et nytt marked er tallfestet.
LTV/CAC-ratioen måles per markedstype, og minst én markedstype bør oppnå
ratio på minst 3 \parencite{understory_ltvcac}. Dersom begge markedstypene
passerer terskelen, prioriteres den med høyest absolutt bidrag til
omsetningen. Dersom ingen markedstype når 3-nivået, må videre ekspansjon
utsettes og planen revideres før ny kapital bindes opp.
