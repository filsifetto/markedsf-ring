...
Foodora og Wolt har normalisert 30 minutters leveringstid, og den utbredte
bruken av disse tjenestene (jf.\ vedlegg~\ref{app:sporreundersokelse})
tilsier at forbrukerne ikke opplever ventetiden som et tydelig problem. Gapet mellom ønsket og
...
levering. Dette er også bekymringene respondentene og
fokusgruppedeltakerne fremhevet sterkest (jf.\
vedlegg~\ref{app:sporreundersokelse} og \ref{app:fokusgruppe}), og noen
forbrukere vil avvise tjenesten uavhengig av pris og hastighet. Zipline kan møte dette på to måter. Den første er å forenkle
