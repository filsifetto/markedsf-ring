...
markedsindikatorene er aktiv kundebase, gjenkjøp, andel ordre som erstatter
substitutter, CAC per aktiv kunde og konvertering til første kjøp. Snittkurv
og bidragsmargin bør også måles, men de bør komme etter kundevekst og
gjenkjøp i tidlig fase. I tillegg bør Zipline måle opplevd trygghet,
støyreaksjoner, NPS og anbefalinger fra eksisterende kunder.
...
sortimentet eller appopplevelsen. Hvis mange besøker appen fra dekningssonen,
men få kjøper, må førstegangstilbudet, sikkerhetsbudskapet eller
bestillingsflyten forbedres. Kjennskap bør måles, men den bør ikke være en
hoved-KPI i denne fasen.

Hver tredje måned brytes resultatene ned per marked og segmenttype for å
vurdere CAC, LTV og bidragsmargin per kundegruppe. Dette gir grunnlag for
å reallokere markedsbudsjett mellom Nesodden, Bærum og Asker etter hvert
som data akkumuleres, og fanger lønnsomhetsforskjeller som månedlig
driftskontroll ikke nødvendigvis avdekker. Eierskapet ligger hos
økonomiansvarlig i dialog med markedsansvarlig.

\subsubsection{Faseporter}

Faseoverganger skal være beslutninger, ikke kalenderautomatikk. Ved måned 3
vurderes de første Nesodden-dataene. Ved måned 6 avgjøres om Bærum kan
forberedes eller om Nesodden må forlenges. Ved måned 12 vurderes Bærum før
Asker eventuelt legges til som replisering innen samme segment. Ved måned 18
vurderes Bærum og eventuell drift i Asker opp mot kravet til aktiv kundebase og
gjenkjøp. Ved måned 24 avgjør ledelsen hvilket marked Zipline bør gå videre
til.
