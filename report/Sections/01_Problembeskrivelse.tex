% !TEX root = ../main.tex
% Agent documentation:
% Purpose: introduce Zipline, narrow the scope to grocery and restaurant
% delivery in Norway, and define the central market-entry problem.
% Upstream evidence: company facts, product claims, problem-definition theory,
% jobs-to-be-done, and positioning theory.
% Downstream use: all later analysis assumes this scope. Avoid drifting into
% general parcel logistics, healthcare delivery, or tactical recommendations.
...
\parencite{ziplineabout}. Tjenesten er lansert i Pea Ridge i Arkansas og i
flere lokalsamfunn i Dallas-Fort Worth-området
\parencite{ziplinefactsheet}. I Walmart-samarbeidet i Pea Ridge er
leveranser omtalt som innen 15 minutter fra bestilling. Leveringen er helt
kontaktfri \parencite{time2022_zipline, korosec2026}.

Den tekniske løsningen bak tjenesten er Ziplines Platform 2-drone. Dette er en
helelektrisk VTOL-drone (vertikal start og landing) som flyr med en hastighet
på opptil 110 km/t \parencite{ziplinefactsheet}. Når dronen ankommer
leveringsadressen, svever den om lag 100 meter over bakken og senker ned
pakken uten at dronen selv lander \parencite{ziplinefactsheet}. Slik begrenser
løsningen også støyen i forbindelse med leveransen. Systemet har en
leveringsradius på omtrent 16 km og støtter en maksimal leveransevekt på 3,6
kg
\parencite{ziplinefactsheet}.
...
sammenlignet med tradisjonelle leveringsmetoder \parencite{zipline_ntia2024}.
...
verdien faktisk vil bli oppfattet som relevant av kundene. Det holder ikke at
Ziplines tjeneste er teknologisk avansert i seg selv. Den må også fremstå som
meningsfull, attraktiv og bedre egnet enn eksisterende alternativer sett fra
kundens perspektiv \parencite[Forelesning 2]{aspelund2026_forelesninger}.
Dette samsvarer med
...
bevissthet \parencite[Forelesning 5]{aspelund2026_forelesninger}. Dette er
særlig viktig i
markeder der nye aktører ikke bare må introdusere noe nytt, men også skape en
overbevisende begrunnelse for hvorfor kundene bør velge løsningen fremfor
etablerte alternativer.
