...
påvirke batterikapasitet, sensorer og flysikkerhet. 

\subsubsection{Miljømessige faktorer}
% det med klima kommer frem i intern analysen i stedet for
...
% må ha kilde på setningen som starter med " Videre stiller norsk personvernlovgivning..", altså må kildehenvise til den norske personvernlovgivningen
...
tegner ansvarsforsikring, noe som kan utgjøre en merkbar kostnad. % må ha kilde på europeisk regelverk i den siste setningen her
...
% må ha kilde på 100--300MUSD eller endre tallet så det passer med en kilde, hvis ikke må du skrive at det er en antakelse
...
% endre språket i dette avsnittet så det høres bedre ut. Endre porter-kilden, han har ikke sagt "Byttekostnaden er i praksis null", finn en annen kilde eller omformuler så det passer med en annen relevant kilde i dette scenariet
...
% oppdater avsnittet under så det ikke står at Zipline har en høyere kostnad. Zipline skal operere med en lavere pris.
% omformuler slik du mener det blir best mulig og riktig. Og ikke la det være motsigelser med resten av teksten
...
% må ha kilde på alt i denne setningen "Aviant har imidlertid hentet totalt
% 7,7~MUSD mot Ziplines 600~MUSD i siste runde alene, og har gjennomført i
% overkant av 500 leveranser."
% vurdere å fjerne eller omformulere setningen med Kyte
...
% vurdere om dette avsnittet skal fjernes eller justeres så det ikke overlapper med SWOT
